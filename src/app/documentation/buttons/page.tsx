...
`
    ...
    return (
        <>
            <SideBarNavigation>
                <li className="text-main-white text-sm ml-4 mt-1">    
                    <a href="#standard_buttons">Standard Buttons</a>
                </li>
            </SideBarNavigation>
            <DocsSection>
                <section className="mt-2" id="standard_buttons">
                    ...
                    <hr className="my-8 border-main-gray mr-80" />
                    ...
                    <div className="border rounded-md max-w-xl border-main-accent mt-4 mb-4">
                        ...
                        <div className='flex justify-between p-1 bg-gray-600 text-white items-center text text-base max-w-xl'>
                            <p>Button - Default</p>
                            <button onClick={() => copyCode(codeString)} className='p-2 duration-200 bg-main-gray/40 rounded text-sm'>
