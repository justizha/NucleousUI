...
export default function Faq() {
    return (
        <section className=" lg:pt-20 lg:pb-20 pb-16 pt-16">
            <div className="">
                <h1 className="md:text-4xl text-[30px] font-bold text-start mb-10 md:mx-8 mx-2">
                    Frequently asked questions
                </h1>
            </div>
            <div className="pt-5 grid  md:grid-cols-3 ">
                <div className="border-b md:border-r border-gray-400 p-2 ">
                    <h2 className="text-base font-semibold flex items-center mb-2">
