                    ...
                    <Transition
                        ...
                        <Menu.Items className='absolute right-0 top-0  w-[70%] overflow-y-auto h-screen origin-top-right  bg-main-black z-50 border-l py-4 border-main-gray'>
                            <ul className="list-none mx-4 text-start flex justify-center flex-col mt-1 gap-2">
                                ...
                                <Link href={'/about'} className='text-base flex gap-1 text-main-white bg-opacity-95 bg-main-accent hover:bg-opacity-70 hover:text-gray-200 duration-150 rounded max-w-sm px-4 py-2'
                                >
                                    <HelpCircle />    About
                                </Link>
                                <Link href={'/#contact'} className='text-base flex gap-1 text-main-white bg-opacity-95 bg-main-accent hover:bg-opacity-70 hover:text-gray-200 duration-150 rounded max-w-sm px-4 py-2'
                                >
                                    <Mail />    Contact
                                </Link>
                                <Link href={'/#'} className='text-base flex gap-1 text-main-white bg-opacity-95 bg-main-accent hover:bg-opacity-70 hover:text-gray-200 duration-150 rounded max-w-sm px-4 py-2'
                                >
                                    <Newspaper />    Blogs
                                </Link>
                                <Link href={'/about'} className='text-base flex gap-1 text-main-white bg-opacity-95 bg-main-accent hover:bg-opacity-70 hover:text-gray-200 duration-150 rounded max-w-sm px-4 py-2'
